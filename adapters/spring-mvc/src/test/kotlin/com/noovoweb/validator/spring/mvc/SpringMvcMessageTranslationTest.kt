...
class SpringMvcMessageTranslationTest {
    @Test
    fun `Spring MVC module falls back to core translations for built-in validators`() =
        runTest {
    ...
    @Test
    fun `Spring MessageSource can override core translations`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `custom Spring messages work with parameters`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `Spring MVC can use application-specific message bundles`() =
        runTest {
    ...
    @Test
    fun `all core validator messages are accessible through Spring MVC`() =
        runTest {
            val messageSource = StaticMessageSource()
            val provider = SpringMessageProvider(messageSource)
    ...
    @Test
    fun `Spring MVC preserves parameter interpolation for translated messages`() =
        runTest {
            val messageSource = StaticMessageSource()
            val provider = SpringMessageProvider(messageSource)
    ...
    @Test
    fun `Spring MessageSource priority is correct - custom before default`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `Spring MVC handles missing custom translations gracefully`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `Spring MVC supports locale-specific message resolution`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `all validator categories are translated through Spring MVC`() =
        runTest {
            val messageSource = StaticMessageSource()
            val provider = SpringMessageProvider(messageSource)
