...
class SpringValidatorAdapterTest {
    ...
    class PassingValidator : GeneratedValidator<TestUser> {
        ...
        override suspend fun validateResult(payload: TestUser, context: ValidationContext): com.noovoweb.validator.ValidationResult<TestUser> {
    ...
    class FailingValidator : GeneratedValidator<TestUser> {
        ...
        override suspend fun validateResult(payload: TestUser, context: ValidationContext): com.noovoweb.validator.ValidationResult<TestUser> {
            return com.noovoweb.validator.ValidationResult.Failure(mapOf(
    ...
    fun `should support the target class`() {
        val adapter = SpringValidatorAdapter(
