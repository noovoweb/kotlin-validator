...
class SpringMessageProviderTest {
    ...
    @Test
    fun `should delegate to Spring MessageSource for custom messages`() = runTest {
    ...
    @Test
    fun `should fall back to DefaultMessageProvider for built-in messages`() = runTest {
        val messageSource = StaticMessageSource()
        val provider = SpringMessageProvider(messageSource)
    ...
    @Test
    fun `should interpolate parameters from Spring MessageSource`() = runTest {
        val messageSource = StaticMessageSource()
    ...
    @Test
    fun `should handle different locales from Spring`() = runTest {
        val messageSource = StaticMessageSource()
    ...
    @Test
    fun `should return key if message not found anywhere`() = runTest {
        val messageSource = StaticMessageSource()
        val provider = SpringMessageProvider(messageSource)
    ...
    @Test
    fun `should prioritize Spring messages over default`() = runTest {
        val messageSource = StaticMessageSource()
    ...
    @Test
    fun `should handle null parameters gracefully`() = runTest {
        val messageSource = StaticMessageSource()
    ...
    @Test
    fun `should handle empty parameters array`() = runTest {
        val messageSource = StaticMessageSource()
        messageSource.addMessage("simple.message", Locale.ENGLISH, "No parameters")
