...
class SpringWebFluxMessageTranslationTest {
    @Test
    fun `Spring WebFlux module falls back to core translations for built-in validators`() =
        runTest {
    ...
    @Test
    fun `Spring MessageSource can override core translations in WebFlux`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `custom Spring messages work with parameters in WebFlux`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `Spring WebFlux can use application-specific message bundles`() =
        runTest {
    ...
    @Test
    fun `all core validator messages are accessible through Spring WebFlux`() =
        runTest {
            val messageSource = StaticMessageSource()
            val provider = SpringMessageProvider(messageSource)
    ...
    @Test
    fun `Spring WebFlux preserves parameter interpolation for translated messages`() =
        runTest {
            val messageSource = StaticMessageSource()
            val provider = SpringMessageProvider(messageSource)
    ...
    @Test
    fun `Spring MessageSource priority is correct in WebFlux - custom before default`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `Spring WebFlux handles missing custom translations gracefully`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `Spring WebFlux supports locale-specific message resolution`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `all validator categories are translated through Spring WebFlux`() =
        runTest {
            val messageSource = StaticMessageSource()
            val provider = SpringMessageProvider(messageSource)
    ...
    @Test
    fun `reactive context preserves locale for translations`() =
        runTest {
            val messageSource = StaticMessageSource()
    ...
    @Test
    fun `WebFlux translations work with async validation flows`() =
        runTest {
            val messageSource = StaticMessageSource()
            val provider = SpringMessageProvider(messageSource)
