...
class ValidationExtensionsTest {
    ...
    @Test
    fun `receiveAndValidate should validate successfully with passing validator`() =
        testApplication {
            application {
    ...
    @Test
    fun `receiveAndValidate should return 422 with failing validator`() =
        testApplication {
            application {
                install(ValidationPlugin)
                install(ContentNegotiation) {
    ...
    @Test
    fun `receiveAndValidate with custom context should use provided context`() =
        testApplication {
    ...
    @Test
    fun `validate extension should validate successfully`() =
        testApplication {
            application {
                install(ValidationPlugin)
                install(ContentNegotiation) {
    ...
    @Test
    fun `validate extension should fail with failing validator`() =
        testApplication {
            application {
                install(ValidationPlugin)
                install(ContentNegotiation) {
    ...
    @Test
    fun `validation should extract locale from Accept-Language in receiveAndValidate`() =
        testApplication {
            var capturedLocale: Locale? = null
