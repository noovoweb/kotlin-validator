...
class MessageProviderTest {
    ...
    @Test
    fun `DefaultMessageProvider loads English messages`() = runTest {
    ...
    @Test
    fun `DefaultMessageProvider loads French messages`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage returns English by default`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage returns French when requested`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage interpolates single parameter`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage interpolates multiple parameters`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage falls back to English for unsupported locale`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage returns key if message not found`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage returns consistent results for same inputs`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `DefaultMessageProvider supports multiple validator types`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage with parameters in French`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage handles parameter array correctly`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getMessage with empty parameters array`() = runTest {
        val provider = DefaultMessageProvider()
    ...
    @Test
    fun `getAllMessages loads for supported locales`() = runTest {
        val provider = DefaultMessageProvider()
