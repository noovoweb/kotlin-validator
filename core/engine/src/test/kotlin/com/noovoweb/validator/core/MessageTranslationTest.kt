...
class MessageTranslationTest {
    ...
    @Test
    fun `all string validator messages are translated to French`() = runTest {
        val keys = listOf(
            "field.required",
            "field.email",
            "field.url",
    ...
    @Test
    fun `all numeric validator messages are translated to French`() = runTest {
        val keys = listOf(
            "field.min",
            "field.max",
            "field.between",
    ...
    @Test
    fun `all collection validator messages are translated to French`() = runTest {
        val keys = listOf(
            "field.size",
            "field.minsize",
            "field.maxsize",
    ...
    @Test
    fun `all date-time validator messages are translated to French`() = runTest {
        val keys = listOf(
            "field.dateformat",
            "field.isodate",
            "field.isodatetime",
    ...
    @Test
    fun `all network validator messages are translated to French`() = runTest {
        val keys = listOf(
            "field.ipv4",
            "field.ipv6",
            "field.ip",
    ...
    @Test
    fun `all file validator messages are translated to French`() = runTest {
        val keys = listOf(
            "field.mimetype",
            "field.fileextension",
            "field.maxfilesize"
    ...
    @Test
    fun `all conditional validator messages are translated to French`() = runTest {
        val keys = listOf(
            "field.same",
            "field.different",
            "field.requiredif",
    ...
    @Test
    fun `boolean validator messages are translated to French`() = runTest {
    ...
    @Test
    fun `security validator messages are translated to French`() = runTest {
        val keys = listOf(
    ...
    @Test
    fun `messages with parameters are translated correctly`() = runTest {
        val testCases = mapOf(
    ...
    @Test
    fun `French translations use correct French terminology`() = runTest {
    ...
    @Test
    fun `all message keys exist in both English and French`() = runTest {
