...
class CoreIntegrationTest {
    @Test
    fun `ValidationContext with custom MessageProvider works end-to-end`() =
        runTest {
    ...
    @Test
    fun `ValidationException integrates with MessageProvider`() =
        runTest {
            val provider = DefaultMessageProvider()
    ...
    @Test
    fun `Locale switching changes message language`() =
        runTest {
            val provider = DefaultMessageProvider()
    ...
    @Test
    fun `Full validation flow ValidationContext Result Exception`() =
        runTest {
            val provider = DefaultMessageProvider()
            val context =
                ValidationContext(
    ...
    @Test
    fun `Multiple components work together with immutability`() =
        runTest {
    ...
    @Test
    fun `Error messages with parameters in validation context`() =
        runTest {
            val provider = DefaultMessageProvider()
            val context =
                ValidationContext(
