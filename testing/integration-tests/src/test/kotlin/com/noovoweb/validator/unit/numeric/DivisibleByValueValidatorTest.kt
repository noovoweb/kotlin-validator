...
class DivisibleByValueValidatorTest {
    @Test
    fun `divisibleby validator accepts values divisible by divisor`() =
        runTest {
    ...
    @Test
    fun `divisibleby validator rejects values not divisible by divisor`() =
        runTest {
            val validator = DivisibleByValueValidator()
    ...
    @Test
    fun `divisibleby validator allows null when not required`() =
        runTest {
            val validator = DivisibleByValueValidator()
    ...
    @Test
    fun `divisibleby validator provides error message`() =
        runTest {
            val validator = DivisibleByValueValidator()
