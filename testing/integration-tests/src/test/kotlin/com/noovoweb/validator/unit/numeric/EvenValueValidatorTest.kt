...
class EvenValueValidatorTest {
    @Test
    fun `even validator accepts even numbers`() =
        runTest {
    ...
    @Test
    fun `even validator rejects odd numbers`() =
        runTest {
            val validator = EvenValueValidator()
    ...
    @Test
    fun `even validator allows null when not required`() =
        runTest {
            val validator = EvenValueValidator()
    ...
    @Test
    fun `even validator provides error message`() =
        runTest {
            val validator = EvenValueValidator()
