...
class IntegerValueValidatorTest {
    ...
    @Test
    fun `integer validator accepts whole numbers`() = runTest {
    ...
    @Test
    fun `integer validator rejects decimal numbers`() = runTest {
        val validator = IntegerValueValidator()
    ...
    @Test
    fun `integer validator allows null when not required`() = runTest {
        val validator = IntegerValueValidator()
        validator.validate(IntegerValue(value = null))
    }

    @Test
    fun `integer validator provides error message`() = runTest {
        val validator = IntegerValueValidator()
