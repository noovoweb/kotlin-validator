...
class PatternValidatorTest {
    @Test
    fun `pattern validator accepts strings matching pattern`() =
        runTest {
    ...
    @Test
    fun `pattern validator rejects strings not matching pattern`() =
        runTest {
            val validator = PatternValidator()
    ...
    @Test
    fun `pattern validator allows null when not required`() =
        runTest {
            val validator = PatternValidator()
    ...
    @Test
    fun `pattern validator provides error message`() =
        runTest {
            val validator = PatternValidator()
