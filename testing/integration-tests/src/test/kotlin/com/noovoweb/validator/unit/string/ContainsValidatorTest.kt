...
class ContainsValidatorTest {
    ...
    @Test
    fun `contains validator accepts strings with substring`() = runTest {
    ...
    @Test
    fun `contains validator rejects strings without substring`() = runTest {
        val validator = ContainsValidator()
    ...
    @Test
    fun `contains validator allows null when not required`() = runTest {
        val validator = ContainsValidator()
        validator.validate(Contains(name = null))
    }

    @Test
    fun `contains validator provides error message`() = runTest {
        val validator = ContainsValidator()
