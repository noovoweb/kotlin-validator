...
class ValidationExceptionIntegrationTest {
    @Test
    fun `should throw ValidationException with multiple errors`() =
        runTest {
            val exception =
    ...
    @Test
    fun `should validate correct complex format`() =
        runTest {
    ...
    @Test
    fun `should collect specific error fields`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `should validate all format requirements`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `should reject invalid format with all errors`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `should accept valid formatted data`() =
        runTest {
