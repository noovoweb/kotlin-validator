...
class SizeListValidatorTest {
    @Test
    fun `size validator accepts lists within range`() = runTest {
    ...
    @Test
    fun `size validator rejects lists outside range`() = runTest {
        val validator = SizeListValidator()
    ...
    @Test
    fun `size validator allows null`() = runTest {
        SizeListValidator().validate(SizeList(items = null))
    }

    @Test
    fun `size validator provides error message`() = runTest {
