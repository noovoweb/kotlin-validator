...
class EmailValidatorTest {
    ...
    @Test
    fun `email validator accepts valid email addresses`() =
        runTest {
    ...
    @Test
    fun `email validator rejects invalid email addresses`() =
        runTest {
            val validator = EmailValidator()
    ...
    @Test
    fun `email validator allows null when not required`() =
        runTest {
            val validator = EmailValidator()
    ...
    @Test
    fun `email validator provides error message`() =
        runTest {
            val validator = EmailValidator()
