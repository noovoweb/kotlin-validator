...
class IPv6AddressValidatorTest {
    @Test
    fun `ipv6 validator accepts valid IPv6 addresses`() =
        runTest {
    ...
    @Test
    fun `ipv6 validator rejects invalid IPv6 addresses`() =
        runTest {
            val validator = IPv6AddressValidator()
    ...
    @Test
    fun `ipv6 validator allows null when not required`() =
        runTest {
            val validator = IPv6AddressValidator()
    ...
    @Test
    fun `ipv6 validator provides error message`() =
        runTest {
            val validator = IPv6AddressValidator()
