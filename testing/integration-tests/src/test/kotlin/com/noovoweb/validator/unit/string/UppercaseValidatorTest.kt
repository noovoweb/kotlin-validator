...
class UppercaseValidatorTest {
    @Test
    fun `uppercase validator accepts uppercase strings`() =
        runTest {
    ...
    @Test
    fun `uppercase validator rejects non-uppercase strings`() =
        runTest {
            val validator = UppercaseValidator()
    ...
    @Test
    fun `uppercase validator allows null when not required`() =
        runTest {
            val validator = UppercaseValidator()
    ...
    @Test
    fun `uppercase validator provides error message`() =
        runTest {
            val validator = UppercaseValidator()
