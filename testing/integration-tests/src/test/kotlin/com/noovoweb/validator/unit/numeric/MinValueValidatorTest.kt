...
class MinValueValidatorTest {
    ...
    @Test
    fun `min validator accepts values at or above minimum`() = runTest {
    ...
    @Test
    fun `min validator rejects values below minimum`() = runTest {
        val validator = MinValueValidator()
    ...
    @Test
    fun `min validator allows null when not required`() = runTest {
        val validator = MinValueValidator()
        validator.validate(MinValue(value = null))
    }

    @Test
    fun `min validator provides error message`() = runTest {
        val validator = MinValueValidator()
