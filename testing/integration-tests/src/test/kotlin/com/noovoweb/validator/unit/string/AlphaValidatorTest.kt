...
class AlphaValidatorTest {
    ...
    @Test
    fun `alpha validator accepts alphabetic strings`() = runTest {
    ...
    @Test
    fun `alpha validator rejects non-alphabetic strings`() = runTest {
        val validator = AlphaValidator()
    ...
    @Test
    fun `alpha validator allows null when not required`() = runTest {
        val validator = AlphaValidator()
        validator.validate(Alpha(name = null))
    }

    @Test
    fun `alpha validator provides error message`() = runTest {
        val validator = AlphaValidator()
