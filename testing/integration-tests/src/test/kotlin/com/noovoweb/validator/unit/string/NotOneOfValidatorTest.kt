...
class NotOneOfValidatorTest {
    @Test
    fun `notoneof validator accepts values not in forbidden list`() =
        runTest {
    ...
    @Test
    fun `notoneof validator rejects values in forbidden list`() =
        runTest {
            val validator = NotOneOfValidator()
    ...
    @Test
    fun `notoneof validator is case sensitive`() =
        runTest {
            val validator = NotOneOfValidator()
    ...
    @Test
    fun `notoneof validator allows null when not required`() =
        runTest {
            val validator = NotOneOfValidator()
    ...
    @Test
    fun `notoneof validator provides error message`() =
        runTest {
            val validator = NotOneOfValidator()
