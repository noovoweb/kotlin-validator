...
class FailFastValidatorTest {
    @Test
    fun `failfast validator accepts valid value`() =
        runTest {
    ...
    @Test
    fun `failfast at beginning has checkpoint before all validators`() =
        runTest {
    ...
    @Test
    fun `failfast at beginning with invalid email format`() =
        runTest {
            val validator = FailFastAtBeginningValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `failfast at middle checks validators before checkpoint`() =
        runTest {
            val validator = FailFastAtMiddleValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `failfast at middle stops after checkpoint when earlier validator fails`() =
        runTest {
            val validator = FailFastAtMiddleValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `failfast at end allows all validators to run`() =
        runTest {
    ...
    @Test
    fun `failfast at end with null value`() =
        runTest {
            val validator = FailFastAtEndValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `multiple failfast checkpoints - stops at first checkpoint when required fails`() =
        runTest {
    ...
    @Test
    fun `multiple failfast checkpoints - stops at second checkpoint when email fails`() =
        runTest {
            val validator = MultipleFailFastCheckpointsValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `multiple failfast checkpoints - validates maxlength when all previous pass`() =
        runTest {
            val validator = MultipleFailFastCheckpointsValidator()
    ...
    @Test
    fun `multiple failfast checkpoints - passes with valid short email`() =
        runTest {
            val validator = MultipleFailFastCheckpointsValidator()
