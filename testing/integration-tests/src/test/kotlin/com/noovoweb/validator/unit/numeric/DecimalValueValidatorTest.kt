...
class DecimalValueValidatorTest {
    @Test
    fun `decimal validator accepts decimal numbers`() =
        runTest {
    ...
    @Test
    fun `decimal validator rejects whole numbers`() =
        runTest {
            val validator = DecimalValueValidator()
    ...
    @Test
    fun `decimal validator allows null when not required`() =
        runTest {
            val validator = DecimalValueValidator()
    ...
    @Test
    fun `decimal validator provides error message`() =
        runTest {
            val validator = DecimalValueValidator()
