...
class NegativeValueValidatorTest {
    ...
    @Test
    fun `negative validator accepts negative values`() = runTest {
    ...
    @Test
    fun `negative validator rejects zero`() = runTest {
        val validator = NegativeValueValidator()
    ...
    @Test
    fun `negative validator rejects positive values`() = runTest {
        val validator = NegativeValueValidator()
    ...
    @Test
    fun `negative validator allows null when not required`() = runTest {
        val validator = NegativeValueValidator()
        validator.validate(NegativeValue(value = null))
    }

    @Test
    fun `negative validator provides error message`() = runTest {
        val validator = NegativeValueValidator()
