...
class UrlValidatorTest {
    ...
    @Test
    fun `url validator accepts valid URLs`() = runTest {
    ...
    @Test
    fun `url validator rejects invalid URLs`() = runTest {
        val validator = UrlValidator()
    ...
    @Test
    fun `url validator allows null when not required`() = runTest {
        val validator = UrlValidator()
        validator.validate(Url(name = null))
    }

    @Test
    fun `url validator provides error message`() = runTest {
        val validator = UrlValidator()
