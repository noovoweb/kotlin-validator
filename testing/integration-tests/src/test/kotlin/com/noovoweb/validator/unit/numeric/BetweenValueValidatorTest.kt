...
class BetweenValueValidatorTest {
    @Test
    fun `between validator accepts values within range`() =
        runTest {
    ...
    @Test
    fun `between validator rejects values below minimum`() =
        runTest {
            val validator = BetweenValueValidator()
    ...
    @Test
    fun `between validator rejects values above maximum`() =
        runTest {
            val validator = BetweenValueValidator()
    ...
    @Test
    fun `between validator allows null when not required`() =
        runTest {
            val validator = BetweenValueValidator()
    ...
    @Test
    fun `between validator provides error message`() =
        runTest {
            val validator = BetweenValueValidator()
