...
class JsonValidatorTest {
    @Test
    fun `json validator accepts valid JSON strings`() =
        runTest {
    ...
    @Test
    fun `json validator rejects invalid JSON strings`() =
        runTest {
            val validator = JsonValidator()
    ...
    @Test
    fun `json validator allows null when not required`() =
        runTest {
            val validator = JsonValidator()
    ...
    @Test
    fun `json validator provides error message`() =
        runTest {
            val validator = JsonValidator()
