...
class AsciiValidatorTest {
    ...
    @Test
    fun `ascii validator accepts ASCII strings`() = runTest {
    ...
    @Test
    fun `ascii validator rejects non-ASCII strings`() = runTest {
        val validator = AsciiValidator()
    ...
    @Test
    fun `ascii validator allows null when not required`() = runTest {
        val validator = AsciiValidator()
        validator.validate(Ascii(name = null))
    }

    @Test
    fun `ascii validator provides error message`() = runTest {
        val validator = AsciiValidator()
