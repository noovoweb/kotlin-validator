...
class PositiveValueValidatorTest {
    ...
    @Test
    fun `positive validator accepts positive values`() = runTest {
    ...
    @Test
    fun `positive validator rejects zero`() = runTest {
        val validator = PositiveValueValidator()
    ...
    @Test
    fun `positive validator rejects negative values`() = runTest {
        val validator = PositiveValueValidator()
    ...
    @Test
    fun `positive validator allows null when not required`() = runTest {
        val validator = PositiveValueValidator()
        validator.validate(PositiveValue(value = null))
    }

    @Test
    fun `positive validator provides error message`() = runTest {
        val validator = PositiveValueValidator()
