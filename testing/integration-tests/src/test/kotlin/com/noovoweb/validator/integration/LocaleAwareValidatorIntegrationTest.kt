...
class LocaleAwareValidatorIntegrationTest {
    ...
    @Test
    fun `should validate US date format`() = runTest {
    ...
    @Test
    fun `should validate French date format`() = runTest {
    ...
    @Test
    fun `should validate German date format`() = runTest {
    ...
    @Test
    fun `should reject wrong format for locale`() = runTest {
        val context = ValidationContext(locale = java.util.Locale.US)
        val isValid = LocaleAwareValidators.validateDateFormat("31-12-2024", context)
        assertFalse(isValid)
    }
    ...
    @Test
    fun `should accept different formats for different locales`() = runTest {
    ...
    @Test
    fun `should use default locale when not specified`() = runTest {
