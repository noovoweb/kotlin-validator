...
class RegisterRequestValidatorTest {
    ...
    @Test
    fun `email too long fails validation`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `password mismatch fails validation`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `first name too short fails validation`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `first name with non-alpha characters fails validation`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `nullable last name can be null`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `age below minimum fails validation`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `age above maximum fails validation`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `invalid phone number pattern fails validation`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `validateResult returns Success for valid request`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
    ...
    @Test
    fun `validateResult returns Failure for invalid request`() =
        runTest {
            val validator = RegisterRequestValidator()
            val request =
                RegisterRequest(
