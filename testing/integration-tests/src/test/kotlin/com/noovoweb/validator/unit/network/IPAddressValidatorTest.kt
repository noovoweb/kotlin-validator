...
class IPAddressValidatorTest {
    @Test
    fun `ip validator accepts valid IPv4 addresses`() =
        runTest {
    ...
    @Test
    fun `ip validator accepts valid IPv6 addresses`() =
        runTest {
            val validator = IPAddressValidator()
    ...
    @Test
    fun `ip validator rejects invalid IP addresses`() =
        runTest {
            val validator = IPAddressValidator()
    ...
    @Test
    fun `ip validator allows null when not required`() =
        runTest {
            val validator = IPAddressValidator()
    ...
    @Test
    fun `ip validator provides error message`() =
        runTest {
            val validator = IPAddressValidator()
