...
class AsyncValidatorIntegrationTest {
    ...
    @Test
    fun `should support async operations`() = runTest {
    ...
    @Test
    fun `should reject blacklisted usernames`() = runTest {
        val context = ValidationContext()
    ...
    @Test
    fun `should be case-insensitive for blacklist`() = runTest {
        val context = ValidationContext()
    ...
    @Test
    fun `should accept non-blacklisted usernames`() = runTest {
        val context = ValidationContext()
    ...
    @Test
    fun `should handle async validation with delay`() = runTest {
