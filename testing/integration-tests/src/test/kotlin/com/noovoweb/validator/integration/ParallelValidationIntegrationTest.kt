...
class ParallelValidationIntegrationTest {
    @Test
    fun `should support parallel validation`() =
        runTest {
    ...
    @Test
    fun `parallel validation should be faster than sequential validators`() =
        runTest {
    ...
    @Test
    fun `should validate both fields in parallel mode`() =
        runTest {
            val validator = ParallelDataValidator()
    ...
    @Test
    fun `should validate complex data with multiple fields`() =
        runTest {
            val validator = ParallelDataValidator()
