...
class NestedArrayValidationIntegrationTest {
    ...
    @Test
    fun `should validate deeply nested arrays with correct error paths`() = runTest {
    ...
    @Test
    fun `should validate valid deeply nested arrays`() = runTest {
        val validator = OrganizationValidator()
    ...
    @Test
    fun `should collect multiple errors across nested arrays`() = runTest {
        val validator = OrganizationValidator()
    ...
    @Test
    fun `should handle empty nested arrays`() = runTest {
        val validator = OrganizationValidator()
    ...
    @Test
    fun `should handle null nested arrays`() = runTest {
        val validator = OrganizationValidator()
    ...
    @Test
    fun `should provide correct index in error path for middle element`() = runTest {
        val validator = OrganizationValidator()
    ...
    @Test
    fun `should validate multiple departments with mixed valid and invalid data`() = runTest {
        val validator = OrganizationValidator()
