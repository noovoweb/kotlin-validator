...
class LengthValidatorTest {
    ...
    @Test
    fun `length validator accepts strings within range`() = runTest {
    ...
    @Test
    fun `length validator rejects strings too short`() = runTest {
        val validator = LengthValidator()
    ...
    @Test
    fun `length validator rejects strings too long`() = runTest {
        val validator = LengthValidator()
    ...
    @Test
    fun `length validator allows null when not required`() = runTest {
        val validator = LengthValidator()
        validator.validate(Length(name = null))
    }

    @Test
    fun `length validator provides error message`() = runTest {
        val validator = LengthValidator()
