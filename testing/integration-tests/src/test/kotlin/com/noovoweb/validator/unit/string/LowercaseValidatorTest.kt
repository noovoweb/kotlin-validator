...
class LowercaseValidatorTest {
    @Test
    fun `lowercase validator accepts lowercase strings`() =
        runTest {
    ...
    @Test
    fun `lowercase validator rejects non-lowercase strings`() =
        runTest {
            val validator = LowercaseValidator()
    ...
    @Test
    fun `lowercase validator allows null when not required`() =
        runTest {
            val validator = LowercaseValidator()
    ...
    @Test
    fun `lowercase validator provides error message`() =
        runTest {
            val validator = LowercaseValidator()
