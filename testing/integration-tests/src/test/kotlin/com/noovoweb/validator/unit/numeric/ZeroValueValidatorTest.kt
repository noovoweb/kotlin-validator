...
class ZeroValueValidatorTest {
    @Test
    fun `zero validator accepts zero`() =
        runTest {
    ...
    @Test
    fun `zero validator rejects positive values`() =
        runTest {
            val validator = ZeroValueValidator()
    ...
    @Test
    fun `zero validator rejects negative values`() =
        runTest {
            val validator = ZeroValueValidator()
    ...
    @Test
    fun `zero validator allows null when not required`() =
        runTest {
            val validator = ZeroValueValidator()
    ...
    @Test
    fun `zero validator provides error message`() =
        runTest {
            val validator = ZeroValueValidator()
