...
class AlphanumericValidatorTest {
    ...
    @Test
    fun `alphanumeric validator accepts alphanumeric strings`() = runTest {
    ...
    @Test
    fun `alphanumeric validator rejects non-alphanumeric strings`() = runTest {
        val validator = AlphanumericValidator()
    ...
    @Test
    fun `alphanumeric validator allows null when not required`() = runTest {
        val validator = AlphanumericValidator()
        validator.validate(Alphanumeric(name = null))
    }

    @Test
    fun `alphanumeric validator provides error message`() = runTest {
        val validator = AlphanumericValidator()
