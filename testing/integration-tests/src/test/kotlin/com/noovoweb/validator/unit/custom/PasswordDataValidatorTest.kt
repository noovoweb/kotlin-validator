...
class PasswordDataValidatorTest {
    @Test
    fun `custom validator accepts strong password`() =
        runTest {
    ...
    @Test
    fun `custom validator rejects password without uppercase`() =
        runTest {
            val validator = PasswordDataValidator()
            val exception =
    ...
    @Test
    fun `custom validator rejects password without lowercase`() =
        runTest {
            val validator = PasswordDataValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `custom validator rejects password without digit`() =
        runTest {
            val validator = PasswordDataValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `custom validator rejects password without special character`() =
        runTest {
            val validator = PasswordDataValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `custom validator rejects password too short`() =
        runTest {
            val validator = PasswordDataValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `custom validator combines with other validators`() =
        runTest {
            val validator = PasswordDataValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `custom validator uses custom message`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
