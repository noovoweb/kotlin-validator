...
class OddValueValidatorTest {
    ...
    @Test
    fun `odd validator accepts odd numbers`() = runTest {
    ...
    @Test
    fun `odd validator rejects even numbers`() = runTest {
        val validator = OddValueValidator()
    ...
    @Test
    fun `odd validator allows null when not required`() = runTest {
        val validator = OddValueValidator()
        validator.validate(OddValue(value = null))
    }

    @Test
    fun `odd validator provides error message`() = runTest {
        val validator = OddValueValidator()
