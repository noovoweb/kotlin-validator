...
class MaxValueValidatorTest {
    ...
    @Test
    fun `max validator accepts values at or below maximum`() = runTest {
    ...
    @Test
    fun `max validator rejects values above maximum`() = runTest {
        val validator = MaxValueValidator()
    ...
    @Test
    fun `max validator allows null when not required`() = runTest {
        val validator = MaxValueValidator()
        validator.validate(MaxValue(value = null))
    }

    @Test
    fun `max validator provides error message`() = runTest {
        val validator = MaxValueValidator()
