...
class NotContainsListValidatorTest {
    @Test
    fun `notcontains validator accepts lists without forbidden value`() =
        runTest {
    ...
    @Test
    fun `notcontains validator rejects lists with forbidden value`() =
        runTest {
            val validator = NotContainsListValidator()
    ...
    @Test
    fun `notcontains validator allows null`() =
        runTest {
            NotContainsListValidator().validate(NotContainsList(items = null))
        }

    @Test
    fun `notcontains validator provides error message`() =
        runTest {
            val exception =
