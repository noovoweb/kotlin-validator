...
class UserWithCustomValidationValidatorTest {
    @Test
    fun `custom validator accepts valid username`() =
        runTest {
    ...
    @Test
    fun `custom validator rejects username too short`() =
        runTest {
            val validator = UserWithCustomValidationValidator()
            val exception =
    ...
    @Test
    fun `custom validator rejects username with special chars`() =
        runTest {
            val validator = UserWithCustomValidationValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `custom validator rejects username with spaces`() =
        runTest {
            val validator = UserWithCustomValidationValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `custom validator allows underscore in username`() =
        runTest {
            val validator = UserWithCustomValidationValidator()
    ...
    @Test
    fun `custom validator provides error message`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
