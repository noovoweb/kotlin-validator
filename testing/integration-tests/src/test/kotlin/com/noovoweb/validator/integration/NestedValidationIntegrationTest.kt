...
class NestedValidationIntegrationTest {
    ...
    @Test
    fun `should validate nested objects in lists`() = runTest {
    ...
    @Test
    fun `should handle empty nested list`() = runTest {
        val validator = OrderValidator()
    ...
    @Test
    fun `should handle null nested list`() = runTest {
        val validator = OrderValidator()
    ...
    @Test
    fun `should validate each item in nested list`() = runTest {
        val validator = OrderValidator()
        val order = Order(
            items = listOf(
