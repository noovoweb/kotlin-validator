...
class RequiredIfFieldValidatorTest {
    @Test
    fun `requiredif validator accepts when condition met and field present`() =
        runTest {
    ...
    @Test
    fun `requiredif validator accepts when condition not met`() =
        runTest {
            val validator = RequiredIfFieldValidator()
    ...
    @Test
    fun `requiredif validator rejects when condition met but field absent`() =
        runTest {
            val validator = RequiredIfFieldValidator()
    ...
    @Test
    fun `requiredif validator provides error message`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
