...
class PortNumberValidatorTest {
    ...
    @Test
    fun `port validator accepts valid port numbers`() = runTest {
    ...
    @Test
    fun `port validator rejects invalid port numbers`() = runTest {
        val validator = PortNumberValidator()
    ...
    @Test
    fun `port validator allows null when not required`() = runTest {
        val validator = PortNumberValidator()
        validator.validate(PortNumber(port = null))
    }

    @Test
    fun `port validator provides error message`() = runTest {
        val validator = PortNumberValidator()
