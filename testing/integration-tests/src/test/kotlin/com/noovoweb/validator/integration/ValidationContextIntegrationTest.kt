...
class ValidationContextIntegrationTest {
    @Test
    fun `should receive correct ValidationContext`() =
        runTest {
    ...
    @Test
    fun `should propagate context to validators`() =
        runTest {
            val customContext =
                ValidationContext(
    ...
    @Test
    fun `should use default context when not specified`() =
        runTest {
    ...
    @Test
    fun `should maintain context across multiple validations`() =
        runTest {
