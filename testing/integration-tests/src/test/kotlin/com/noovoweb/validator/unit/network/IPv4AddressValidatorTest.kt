...
class IPv4AddressValidatorTest {
    @Test
    fun `ipv4 validator accepts valid IPv4 addresses`() =
        runTest {
    ...
    @Test
    fun `ipv4 validator rejects invalid IPv4 addresses`() =
        runTest {
            val validator = IPv4AddressValidator()
    ...
    @Test
    fun `ipv4 validator allows null when not required`() =
        runTest {
            val validator = IPv4AddressValidator()
    ...
    @Test
    fun `ipv4 validator provides error message`() =
        runTest {
            val validator = IPv4AddressValidator()
