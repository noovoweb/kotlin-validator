...
class SameFieldValidatorTest {
    ...
    @Test
    fun `same validator allows null`() = runTest {
        SameFieldValidator().validate(SameField(password = null, passwordConfirmation = null))
    }

    @Test
    fun `same validator provides error message`() = runTest {
