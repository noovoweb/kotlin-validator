...
class OneOfValidatorTest {
    @Test
    fun `oneof validator accepts values in allowed list`() =
        runTest {
    ...
    @Test
    fun `oneof validator rejects values not in allowed list`() =
        runTest {
            val validator = OneOfValidator()
    ...
    @Test
    fun `oneof validator allows null when not required`() =
        runTest {
            val validator = OneOfValidator()
    ...
    @Test
    fun `oneof validator provides error message`() =
        runTest {
            val validator = OneOfValidator()
