...
class RequiredWithoutFieldValidatorTest {
    @Test
    fun `requiredwithout validator accepts when all dependencies absent and field present`() =
        runTest {
    ...
    @Test
    fun `requiredwithout validator accepts when any dependency present`() =
        runTest {
            val validator = RequiredWithoutFieldValidator()
    ...
    @Test
    fun `requiredwithout validator rejects when all dependencies absent but field absent`() =
        runTest {
            val validator = RequiredWithoutFieldValidator()
    ...
    @Test
    fun `requiredwithout validator provides error message`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
                    RequiredWithoutFieldValidator().validate(
                        RequiredWithoutField(email = null, phone = null, mailingAddress = null),
                    )
                }
