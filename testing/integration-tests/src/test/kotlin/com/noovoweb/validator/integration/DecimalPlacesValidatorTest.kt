...
class DecimalPlacesValidatorTest {
    @Test
    fun `@DecimalPlaces should pass with exact decimal places (String)`() =
        runTest {
    ...
    @Test
    fun `@DecimalPlaces should pass with null value`() =
        runTest {
            val validator = PriceDataValidator()
    ...
    @Test
    fun `@DecimalPlaces should fail with no decimal places (String)`() =
        runTest {
            val validator = PriceDataValidator()
            val exception =
    ...
    @Test
    fun `@DecimalPlaces should fail with too few decimal places (String)`() =
        runTest {
            val validator = PriceDataValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `@DecimalPlaces should fail with wrong number of decimal places (String)`() =
        runTest {
            val validator = PriceDataValidator()
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `@DecimalPlaces should pass with valid prices`() =
        runTest {
            val validator = PriceDataValidator()
