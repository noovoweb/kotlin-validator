...
class CollectionWithValidValidatorTest {
    @Test
    fun `valid each validator accepts valid collection items`() =
        runTest {
    ...
    @Test
    fun `valid each validator rejects invalid collection items`() =
        runTest {
            val validator = CollectionWithValidValidator()
    ...
    @Test
    fun `valid each validator allows null collection`() =
        runTest {
            val validator = CollectionWithValidValidator()
    ...
    @Test
    fun `valid each validator provides error path with index`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
    ...
    @Test
    fun `valid each validator validates all invalid items`() =
        runTest {
            val exception =
                assertThrows<ValidationException> {
                    CollectionWithValidValidator().validate(
