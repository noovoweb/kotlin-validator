...
class LuhnValidatorTest {
    ...
    @Test
    fun `@Luhn should pass with valid credit card number`() = runTest {
    ...
    @Test
    fun `@Luhn should pass with spaces and hyphens`() = runTest {
        val validator = CreditCardDataValidator()
    ...
    @Test
    fun `@Luhn should pass with null value`() = runTest {
        val validator = CreditCardDataValidator()
        validator.validate(CreditCardData(cardNumber = null))
    }

    @Test
    fun `@Luhn should fail with invalid credit card number`() = runTest {
        val validator = CreditCardDataValidator()
    ...
    @Test
    fun `@Luhn should fail with non-digit characters`() = runTest {
        val validator = CreditCardDataValidator()
        val exception = assertThrows<ValidationException> {
    ...
    @Test
    fun `@Luhn should pass with valid MasterCard number`() = runTest {
        val validator = CreditCardDataValidator()
