...
object PostalCodeValidators {
    suspend fun validateCanadianPostalCode(value: String?, context: ValidationContext): Boolean {
...
class MetaAnnotationTest {
    ...
    @Test
    fun `@ValidCanadianPostalCode should accept valid postal code`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        validator.validate(MetaAnnotationTestData(
            postalCode = "H3Z 2Y7",
            password = "Valid123!@#"
        ))
    }
    ...
    @Test
    fun `@ValidCanadianPostalCode should reject invalid postal code`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
    ...
    @Test
    fun `@ValidCanadianPostalCode should reject postal code without space`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        val exception = assertThrows<ValidationException> {
            validator.validate(MetaAnnotationTestData(
                postalCode = "H3Z2Y7",
    ...
    @Test
    fun `@ValidCanadianPostalCode should accept null postal code`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        validator.validate(MetaAnnotationTestData(
            postalCode = null,
            password = "Valid123!@#"
    ...
    @Test
    fun `@StrongPassword should accept valid strong password`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        validator.validate(MetaAnnotationTestData(
            postalCode = "H3Z 2Y7",
    ...
    @Test
    fun `@StrongPassword should reject weak password without uppercase`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        val exception = assertThrows<ValidationException> {
            validator.validate(MetaAnnotationTestData(
                postalCode = "H3Z 2Y7",
    ...
    @Test
    fun `@StrongPassword should reject weak password without digit`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        val exception = assertThrows<ValidationException> {
            validator.validate(MetaAnnotationTestData(
                postalCode = "H3Z 2Y7",
    ...
    @Test
    fun `@StrongPassword should reject weak password without special character`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        val exception = assertThrows<ValidationException> {
            validator.validate(MetaAnnotationTestData(
                postalCode = "H3Z 2Y7",
    ...
    @Test
    fun `@StrongPassword should reject short password`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        val exception = assertThrows<ValidationException> {
            validator.validate(MetaAnnotationTestData(
                postalCode = "H3Z 2Y7",
    ...
    @Test
    fun `@StrongPassword should accept null password`() = runTest {
        val validator = MetaAnnotationTestDataValidator()
        validator.validate(MetaAnnotationTestData(
            postalCode = "H3Z 2Y7",
            password = null
    ...
    @Test
    fun `should support combining meta-annotations with built-in validators`() = runTest {
        val validator = CombinedMetaAnnotationDataValidator()
        validator.validate(CombinedMetaAnnotationData(
    ...
    @Test
    fun `should validate all fields when combining meta-annotations and built-in validators`() = runTest {
        val validator = CombinedMetaAnnotationDataValidator()
        val exception = assertThrows<ValidationException> {
            validator.validate(CombinedMetaAnnotationData(
                email = "invalid-email",
    ...
    @Test
    fun `should fail when only meta-annotation validation fails`() = runTest {
        val validator = CombinedMetaAnnotationDataValidator()
        val exception = assertThrows<ValidationException> {
            validator.validate(CombinedMetaAnnotationData(
